...
const ThePurpleRatingFramework = () => {
    const dimensions = [
        ...
        },
        {
            ...
            icon: "/home/emergency-and-safety-readiness.png",
            color: "border-blue-400",
            points: 10,
        ...
        },
        {
            ...
            icon: "/home/feedback-and-continuous-improvement.png",
            color: "border-purple-500",
            points: 10,
            ...
            <section className="relative py-10 bg-[#FBEBFD]">
                <div className="container mx-auto flex flex-col justify-center md:space-y-8 space-y-4 md:px-0 px-4">
                    ...
                    <div className="w-full">
                            ...
                            {dimensions.map((dimension, index) => (
                                <div key={index} className="bg-white rounded-lg p-4 shadow-sm border-2 border-gray-100 hover:shadow-md transition-shadow duration-300">
                                    <div className="flex flex-col space-y-3">
                                        <div className={` w-16 h-16 flex items-center justify-start bg-gray-50`}>
                                            <Image
                                                src={dimension.icon}
                                                alt={dimension.title}
                                                width={32}
                        ...
                        {/* Mobile: 2 cards at a time with horizontal scroll */}
                        <div className="md:hidden flex overflow-x-auto space-x-4 pb-4">
                            {dimensions.map((dimension, index) => (
                                <div key={index} className="bg-white rounded-lg p-4 shadow-sm border-2 border-gray-100 flex-shrink-0 w-[45%] min-w-[160px]">
                        ...
                        <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                            <div className="bg-custom-purple text-white p-4">
                                <div className="grid grid-cols-3 gap-4">
                                    <div className="font-bold Poppins-bold">Category</div>
                                    <div className="font-bold Poppins-bold text-center">Points</div>
                                    <div className="font-bold Poppins-bold">Description</div>
                                </div>
                            </div>
