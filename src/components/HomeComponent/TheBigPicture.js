                ...
                <div className="container mx-auto flex flex-col items-center justify-center md:space-y-8 space-y-4 md:px-0 px-4">
                    ...
                    <div className="w-full flex justify-center">
                        <Image
                            ...
                            width={800}
                            height={600}
                            className="md:w-[60%] w-full h-auto rounded-lg"
                        />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center bg-[#0190CA] rounded-2xl md:px-10 p-4 gap-4 w-full mx-auto">
                        ...
                        <div className="flex justify-center items-center">
                            <Image
                                src="/home/inclussive-business.webp"
                                alt="The Big Picture - Why Inclusion Matters"
                                width={800}
                                height={600}
